...
| API | `services/api` | FastAPI 구조, 정책 엔진/가입승인 순수 함수, Supabase HTTP repository, 결제 서비스 골격, unittest 생성 |
| 인프라 | `infra` | Supabase 웹 연결 가이드, 초기 DB 마이그레이션, 초대코드/가입승인 테이블, RLS 요약 SQL, 파일럿 seed SQL 생성 |
